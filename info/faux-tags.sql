...
tagdisplay = 'argumentation';
insert into tag set tagnorm = normalize_tag('Aristote'), tagdisplay = 'Aristote';
insert into tag set tagnorm = normalize_tag('arts'), tagdisplay = 'arts';
insert into tag set tagnorm = normalize_tag('arts plastiques'),
tagdisplay = 'arts plastiques';
insert into tag set tagnorm = normalize_tag('asie'), tagdisplay = 'asie';
insert into tag set tagnorm = normalize_tag('auditif'), tagdisplay = 'auditif';
...
insert into tag set tagnorm = normalize_tag('Bakhtin, Mikhail'),
tagdisplay = 'Bakhtin, Mikhail';
insert into tag set tagnorm = normalize_tag('bardes'), tagdisplay = 'bardes';
insert into tag set tagnorm = normalize_tag('baroque'), tagdisplay = 'baroque';
insert into tag set tagnorm = normalize_tag('Barthes, Roland'),
tagdisplay = 'Barthes, Roland';
insert into tag set tagnorm = normalize_tag('Benjamin, Walter'),
tagdisplay = 'Benjamin, Walter';
insert into tag set tagnorm = normalize_tag('bibliologie'), tagdisplay
= 'bibliologie';
insert into tag set tagnorm = normalize_tag('biographie'), tagdisplay
= 'biographie';
insert into tag set tagnorm = normalize_tag('bloom'), tagdisplay = 'bloom';
...
insert into tag set tagnorm = normalize_tag('comparatisme'),
tagdisplay = 'comparatisme';
...
= 'description';
insert into tag set tagnorm = normalize_tag('dessidence'), tagdisplay
= 'dessidence';
insert into tag set tagnorm = normalize_tag('destinataire'),
tagdisplay = 'destinataire';
...
tagdisplay = 'documentation';
insert into tag set tagnorm = normalize_tag('douleurs'), tagdisplay = 'douleurs';
...
insert into tag set tagnorm = normalize_tag('focalisation'),
tagdisplay = 'focalisation';
insert into tag set tagnorm = normalize_tag('folklore'), tagdisplay = 'folklore';
insert into tag set tagnorm = normalize_tag('fonctions'), tagdisplay = 'fonctions';
insert into tag set tagnorm = normalize_tag('formalisme'), tagdisplay
= 'formalisme';
insert into tag set tagnorm = normalize_tag('formes'), tagdisplay = 'formes';
...
insert into tag set tagnorm = normalize_tag('Greenblatt, Stephen D.'),
...
= 'imaginaire';
insert into tag set tagnorm = normalize_tag('imagologie'), tagdisplay
= 'imagologie';
...
insert into tag set tagnorm = normalize_tag('instance'), tagdisplay = 'instance';
insert into tag set tagnorm = normalize_tag('institution'), tagdisplay
= 'institution';
...
insert into tag set tagnorm = normalize_tag('Jameson, Fredrick'),
tagdisplay = 'Jameson, Fredrick';
insert into tag set tagnorm = normalize_tag('Japon'), tagdisplay = 'Japon';
insert into tag set tagnorm = normalize_tag('jeunesse'), tagdisplay = 'jeunesse';
insert into tag set tagnorm = normalize_tag('journalisme'), tagdisplay
= 'journalisme';
insert into tag set tagnorm = normalize_tag('Jung, Karl'), tagdisplay
= 'Jung, Karl';
insert into tag set tagnorm = normalize_tag('Kristeva, Julia'),
tagdisplay = 'Kristeva, Julia';
insert into tag set tagnorm = normalize_tag('Lacan, Jacques'),
...
insert into tag set tagnorm = normalize_tag('ludique'), tagdisplay = 'ludique';
insert into tag set tagnorm = normalize_tag('lusophone'), tagdisplay = 'lusophone';
insert into tag set tagnorm = normalize_tag('lyrisme'), tagdisplay = 'lyrisme';
insert into tag set tagnorm = normalize_tag('Maghreb'), tagdisplay = 'Maghreb';
...
tagdisplay = 'New Historicism';
insert into tag set tagnorm = normalize_tag('non-sens'), tagdisplay = 'non-sens';
insert into tag set tagnorm = normalize_tag('ntic'), tagdisplay = 'ntic';
...
insert into tag set tagnorm = normalize_tag('parties'), tagdisplay = 'parties';
insert into tag set tagnorm = normalize_tag('pastoral'), tagdisplay = 'pastoral';
...
insert into tag set tagnorm = normalize_tag('populaire'), tagdisplay = 'populaire';
insert into tag set tagnorm = normalize_tag('portugal'), tagdisplay = 'portugal';
insert into tag set tagnorm = normalize_tag('postcolonial'),
tagdisplay = 'postcolonial';
insert into tag set tagnorm = normalize_tag('postmodernisme'),
tagdisplay = 'postmodernisme';
...
= 'professions';
insert into tag set tagnorm = normalize_tag('psycanalyse'), tagdisplay
= 'psycanalyse';
insert into tag set tagnorm = normalize_tag('psychologie'), tagdisplay
= 'psychologie';
...
insert into tag set tagnorm = normalize_tag('registres'), tagdisplay = 'registres';
insert into tag set tagnorm = normalize_tag('relations'), tagdisplay = 'relations';
...
insert into tag set tagnorm = normalize_tag('romanistique'),
tagdisplay = 'romanistique';
insert into tag set tagnorm = normalize_tag('romantisme'), tagdisplay
= 'romantisme';
insert into tag set tagnorm = normalize_tag('russie'), tagdisplay = 'russie';
insert into tag set tagnorm = normalize_tag('rythme'), tagdisplay = 'rythme';
insert into tag set tagnorm = normalize_tag('sanscrit'), tagdisplay = 'sanscrit';
insert into tag set tagnorm = normalize_tag('satire'), tagdisplay = 'satire';
insert into tag set tagnorm = normalize_tag('savant'), tagdisplay = 'savant';
insert into tag set tagnorm = normalize_tag('scandinavie'), tagdisplay
= 'scandinavie';
...
= 'structures';
insert into tag set tagnorm = normalize_tag('stylistique'), tagdisplay
= 'stylistique';
insert into tag set tagnorm = normalize_tag('sujet'), tagdisplay = 'sujet';
insert into tag set tagnorm = normalize_tag('surnaturel'), tagdisplay
= 'surnaturel';
