...
<input type="hidden"  name="sitesearch" value="www.fabula.org"/>
  ...
  <div id="tabs-menu"/>
     <ul id="menu-haut"/>
      ...
      <li class="current"><a href="http://www.fabula.org" title="Retour à la page d'accueil"/>Accueil</a></li>
      ...
      <li><a href="http://www.fabula.org/ressources.php" title="Annuaire des chercheurs, listes de diffusion et autres outils utiles"/>Ressources</a></li>
             <li class="crea"><a href="http://www.fabula.org/colloques" title="Colloques publiés sur le site Fabula"/>Colloques</a></li><li class="crea"><a href="http://www.fabula.org/atelier.php" title="L'atelier de théorie littéraire de Fabula"/>Atelier</a></li>
      ...
      <li class="crea"><a href="http://www.fabula.org/lht" title="Revue LHT : Littérature Histoire Théorie"/><i>LHT</i></a></li>
       ...
       <li  class="librairie"       ><a href="http://www.fabula.org/librairie.php" title="Librairie de Fabula"/>Librairie</a></li>
    </ul>
...
<div id="bottom_1col"></div>     
<div id="copyright"/>&copy; Tous les textes et documents disponibles sur ce site, sont, sauf mention contraire, protégés par une <a href="http://creativecommons.org/licenses/by-nc-nd/2.0/fr/"/>licence Creative Common</a><br>(diffusion et reproduction libres avec l'obligation de citer l'auteur original et l'interdiction de toute modification et de toute utilisation commerciale sans autorisation préalable).</div>

<br><div class="feed"/><a href="http://www.fabula.org/rss/fabula1.xml"/>Fil d'information RSS</a></div>
</div>
</body>
</html>
